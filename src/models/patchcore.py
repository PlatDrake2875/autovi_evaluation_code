...
class PatchCore:
    ...
    def fit(
        ...
        Args:
            ...
            coreset_method: Method for coreset selection ("greedy" or "kmeans").
                Use "kmeans" for large images to avoid OOM.
            use_projection: If True, apply Sparse Random Projection before greedy
                coreset selection to speed up the process (as per original PatchCore).
        """
